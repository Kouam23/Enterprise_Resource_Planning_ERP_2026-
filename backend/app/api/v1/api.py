from app.api.v1 import auth, courses, students, finance, hr, analytics, programs, grades, academic_docs, fee_structures, tuition_invoices, scholarships, expenses, marketing, finance_ext, hr_ext
